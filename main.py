...
time.sleep(WAIT_TIME)
ac_device_13= AC_Device("ac_3", "Living")
time.sleep(WAIT_TIME)
...
print("\nCommand ID " + str(cmd) + " request is intiated.")
status = edge_server_1.set(cmd, 'single', 'light_1', 'ON')
time.sleep(WAIT_TIME)
print("\nCommand ID " + str(status) + " is executed.")
cmd += 1
...
print("\nControlling the devices based on ID: ")
print("\nCommand ID " + str(cmd) + " request is intiated.")
status = edge_server_1.set(cmd, 'single', 'ac_1', 'ON')
time.sleep(WAIT_TIME)
print("\nCommand ID " + str(status) + " is executed.")
cmd += 1
...
print("\nControlling the devices based on ID: ")
print("\nCommand ID " + str(cmd) + " request is intiated.")
status = edge_server_1.set(cmd, 'single', 'light_1', 'MEDIUM')
time.sleep(WAIT_TIME)
print("\nCommand ID " + str(status) + " is executed.")
cmd += 1
...
print("\nControlling the devices based on ID: ")
print("\nCommand ID " + str(cmd) + " request is intiated.")
status = edge_server_1.set(cmd, 'single', 'ac_1', 29)
time.sleep(WAIT_TIME)
print("\nCommand ID " + str(status) + " is executed.")
cmd += 1
...
print("\nControlling the devices based on ID: ")
print("\nCommand ID " + str(cmd) + " request is intiated.")
status = edge_server_1.set(cmd, 'single', 'light_2', 'HIGH')
time.sleep(WAIT_TIME)
print("\nCommand ID " + str(status) + " is executed.")
cmd += 1
...
print("\nCommand ID " + str(cmd) + " request is intiated.")
status = edge_server_1.set(cmd, 'device_type', 'ac', 21)
time.sleep(WAIT_TIME)
print("\nCommand ID " + str(status) + " is executed.")
cmd += 1
...
print("\nControlling the devices based on TYPE: ")
print("\nCommand ID " + str(cmd) + " request is intiated.")
status = edge_server_1.set(cmd, 'device_type', 'light', 'MEDIUM')
time.sleep(WAIT_TIME)
print("\nCommand ID " + str(status) + " is executed.")
cmd += 1
...
print("\nCommand ID " + str(cmd) + " request is intiated.")
status = edge_server_1.set(cmd, 'room', 'Living', 30)
time.sleep(WAIT_TIME)
print("\nCommand ID " + str(status) + " is executed.")
cmd += 1
...
print("\nControlling the devices based on room: ")
print("\nCommand ID " + str(cmd) + " request is intiated.")
status = edge_server_1.set(cmd, 'all', 'all', 28)
time.sleep(WAIT_TIME)
print("\nCommand ID " + str(status) + " is executed.")
cmd += 1
...
print("\nControlling the devices based on room: ")
print("\nCommand ID " + str(cmd) + " request is intiated.")
status = edge_server_1.set(cmd, 'room', 'Living', 'HIGH')
time.sleep(WAIT_TIME)
print("\nCommand ID " + str(status) + " is executed.")
cmd += 1
...
print("\nControlling the devices based on room: ")
print("\nCommand ID " + str(cmd) + " request is intiated.")
status = edge_server_1.set(cmd, 'all', 'all', 38)
time.sleep(WAIT_TIME)
print("\nCommand ID " + str(status) + " is executed.")
cmd += 1
...
print("\nControlling the devices based on ID: ")
print("\nCommand ID " + str(cmd) + " request is intiated.")
status = edge_server_1.set(cmd, 'single', 'ac_1', 39)
time.sleep(WAIT_TIME)
print("\nCommand ID " + str(status) + " is executed.")
cmd += 1
...
print("\nControlling the devices based on ID: ")
print("\nCommand ID " + str(cmd) + " request is intiated.")
status = edge_server_1.set(cmd, 'single', 'light_4', 'HIGHH')
time.sleep(WAIT_TIME)
print("\nCommand ID " + str(status) + " is executed.")
cmd += 1
